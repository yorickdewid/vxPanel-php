...
function WriteVhostConfigFile()
{
    ...
    //Get email for server admin of vxpanel
    ...
    $line .= "# Automatically generated by vxPanel " . sys_versions::ShowZpanelVersion() . fs_filehandler::NewLine();
    $line .= "# Generated on: " . date( ctrl_options::GetSystemOption( 'zpanel_df' ), time() ) . fs_filehandler::NewLine();
    $line .= "################################################################" . fs_filehandler::NewLine();
    $line .= "" . fs_filehandler::NewLine();

    // vxPanel default virtual host container
    ...
    $line .= "" . fs_filehandler::NewLine();
    $line .= "# Configuration for vxPanel control panel." . fs_filehandler::NewLine();
    ...
    // disable *.zpaneldomain as vxpanel host is already default
    ...
    $line .= "" . fs_filehandler::NewLine();
    $line .= "################################################################" . fs_filehandler::NewLine();
    $line .= "# vxPanel generated VHOST configurations below....." . fs_filehandler::NewLine();
    $line .= "################################################################" . fs_filehandler::NewLine();
    $line .= "" . fs_filehandler::NewLine();
    ...
    // vxpanel virtual host container configuration
