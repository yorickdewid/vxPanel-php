...
class module_controller extends ctrl_module {
	...
	static function getResult() {
		...
		if (!fs_director::CheckForEmptyValue(self::$showPrice)) {
			return ui_sysmessage::shout(ui_language::translate("Not enough credits to proceed with registration."), "zannounceok");
		}
		return;
	}
}
