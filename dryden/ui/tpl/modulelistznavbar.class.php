...
// IF Account, show Gravatar Image
                ...
                foreach ($mods as $mod) {
                    ...
                    if ($mod['mo_installed_ts'] != 0) {
                        ...
                        {
                            $line .= '<a href="?module=' . $mod['mo_folder_vc'] . '"><i class="icon-' . $class_name . ' greyscale"><img src="/modules/' . $mod['mo_folder_path'] .'/'. $mod['mo_folder_vc'] . '/assets/icon.png" height="16px" width="16px"></i> <: ' . $mod['mo_name_vc'] . ' :></a></li>';
                        }
                        else{
