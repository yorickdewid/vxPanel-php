...
dnf install -y php php-common php-cli php-apc php-mysql php-gd php-mcrypt php-curl php-pear php-imap php-xmlrpc php-xsl php-soap libdb-utils webalizer bash-completion dovecot dovecot-pigeonhole dovecot-mysql postfix cyrus-sasl-lib proftpd-mysql phpmyadmin
